...
const mockTutorialProblem: Problem = {
  ...
  constraints: ['Share one honest first impression.', 'Ask the Tutor a question if you want.'],
  scaffold: '# Tutorial question\n# Share a quick first impression.\n\nanswer: \n\nquestion_for_tutor: ',
  examples: [{ input: 'The colors are readable, and I want to know what happens after submit.', output: 'A real first impression is enough.' }],
  expectedApproach: 'Share a quick first impression, optionally ask the Tutor a question, then submit to see feedback.',
  commonPitfalls: ['Leaving the answer blank'],
